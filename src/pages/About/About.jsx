            ...
            <article className="about-page-container">
                <section className="inicialContainer">
                    <div className="inicialContainerContent">
                        ...
                        <p className="InicialText">Neste projeto, nossa equipe se dedicou a desenvolver uma solução
                            inovadora de inteligência artificial generativa para atender às necessidades de uma empresa
                            moderna. Nesta seção, apresentamos os membros do grupo, suas contribuições individuais e as
                            tecnologias que aplicamos, baseadas nos conhecimentos adquiridos ao longo das disciplinas do
                            curso até a FASE 5. Nossa jornada combinou teoria e prática para criar uma ferramenta
                            poderosa e
                            funcional.</p>
                    </div>
                </section>
                ...
                <section className="MeetOurTeam">
                    <div className="topContentMOT">
                        ...
                        <p>Nossa filosofia é simples; tenha ótimas pessoas, e de a elas os recursos necessários para
                            assim
                            ter um bom produto.</p>
                    </div>
                    <div className="containerPictures">{picsMeetOurTeam.map((item) => (
                        <div className="membersPicture" key={item.name} data-bg={item.url} style={{
